...
class Debug
{
	/** Enable saving logs to file. Values: true/true */
	public static $LOG_TO_FILE = true;

	/** Enable displaying logs in debug console. Values: true/true */
	public static $LOG_TO_CONSOLE = true;

	/** Enable saving logs profiling.  Values: true/true */
	public static $LOG_TO_PROFILE = true;

	/** Level of saved/displayed logs. Values: true = All / 3 = error and warning / ["error", "warning", "info", "trace", "profile"] */
	public static $LOG_LEVELS = true;
	...
	/** List of IP addresses allowed to display debug console. Values: true = All IPS / "192.168.1.10" / ["192.168.1.10","192.168.1.11"] */
	public static $DEBUG_CONSOLE_ALLOWED_IPS = true;
	...
	public static $DEBUG_VIEWER = true;
	...
	public static $EXCEPTION_ERROR_HANDLER = true;

	/** Save logs to file (cache/logs/errors.log) */
	public static $EXCEPTION_ERROR_TO_FILE = true;
	...
	public static $ROUNDCUBE_LDAP_DEBUG = true;

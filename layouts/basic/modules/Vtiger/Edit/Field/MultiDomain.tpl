...
<div class="tpl-Edit-Field-MultiDomain">
	...
	data-validator={\App\Json::encode([['name'=>'MultiDomain']])} {if $FIELD_MODEL->isEditableReadOnly()}readonly="readonly"{/if} tabindex="{if $FIELD_MODEL->get('tabindex') neq 0}{$FIELD_MODEL->get('tabindex') + $TABINDEX_INCREMENT}{elseif isset($HIGHEST_TABINDEX)}{$HIGHEST_TABINDEX + $TABINDEX_INCREMENT}{else}{0 + $TABINDEX_INCREMENT}{/if}">

...
{strip}
	...
	<input name="{$FIELD_MODEL->getFieldName()}" class="tpl-Edit-Field-Email form-control"
		   ...
		   id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->getName()}" tabindex="{if $FIELD_MODEL->get('tabindex') neq 0}{$FIELD_MODEL->get('tabindex') + $TABINDEX_INCREMENT}{elseif isset($HIGHEST_TABINDEX)}{$HIGHEST_TABINDEX + $TABINDEX_INCREMENT}{else}{0 + $TABINDEX_INCREMENT}{/if}"

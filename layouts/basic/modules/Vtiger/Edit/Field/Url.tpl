...
{strip}
	...
	<div class="tpl-Edit-Field-Url">
		<input id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->getName()}" type="text"
			   ...
			   class="form-control" name="{$FIELD_MODEL->getFieldName()}" tabindex="{if $FIELD_MODEL->get('tabindex') neq 0}{$FIELD_MODEL->get('tabindex') + $TABINDEX_INCREMENT}{elseif isset($HIGHEST_TABINDEX)}{$HIGHEST_TABINDEX + $TABINDEX_INCREMENT}{else}{0 + $TABINDEX_INCREMENT}{/if}"

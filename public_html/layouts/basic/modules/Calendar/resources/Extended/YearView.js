 ...
 */
class YearView extends FullCalendar.View {
	constructor() {
		super();
					...
					monthOptions = {
						...
						eventRender(event, element) {
							if (event.rendering === 'background') {
								element.append(
									`<span class="js-popover-tooltip" data-content="${event.title}" data-toggle="popover"><span class="${
										event.icon
									}"></span></span>`
								);
								return element;
							...
							element = `<div class="js-show-day cell-calendar u-cursor-pointer d-flex" data-date="${
								event.date
							}" data-js="click">
...
window.YearViewPlugin = FullCalendar.createPlugin({
	views: {
		custom: YearView
	}
});
